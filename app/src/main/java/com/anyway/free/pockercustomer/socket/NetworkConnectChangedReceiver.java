...
public class NetworkConnectChangedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG," intentAction = "+intent.getAction() + "wifiState : "+intent.getIntExtra(WifiManager.EXTRA_WIFI_STATE, 0));
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            if (null != parcelableExtra) {
                ...
                if (isConnected) {
                    NetworkConnectChangedReceiver.isConnect = true;
                    PlayerActivityController.getInstance().startPlayerActivity();
                } else {
                    NetworkConnectChangedReceiver.isConnect = false;
                    PlayerActivityController.getInstance().stopPlayerActivity();
                }
            }
        }
